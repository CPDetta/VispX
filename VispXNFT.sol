...
contract VispXNFT is Ownable, ERC1155, MinterAccess, INftCollection {
    /**
     * Token ID define for type of NFT :
        1 = KING NFT
        2 = KNIGHT NFT
        3 = BISHOP NFT
        4 = QUEEN NFT
    ...
    function mint(
        ...
        if (_id < 5) require(_TokenSupply[_id].add(_amount) <= _MaxSupply[_id], "ERC1155: Mint excess the limit");
